    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center relative z-10">
        ...
        >
          ...
          />
          <button className="flex items-center justify-center gap-2 px-6 py-4 bg-[var(--orange)] hover:bg-[var(--orange-bright)] text-white font-bold rounded-xl transition-all duration-200 hover:scale-105 hover:shadow-[0_0_30px_oklch(0.65_0.22_35/0.5)] whitespace-nowrap">
            Get Started
